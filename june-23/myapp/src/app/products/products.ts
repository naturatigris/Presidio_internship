...
@Component({
  ...
  imports: [Product,FormsModule,CommonModule,InfiniteScrollModule,Navbar],
...
ngOnInit(): void {
  ...
  this.route.parent?.paramMap.subscribe(params => {
    this.usrname = params.get("un");
    console.log("Username from parent route:", this.usrname);
  });
}
