...
namespace FirstAPI.Services
{
    public class DoctorServiceWithTransaction : IDoctorService
    {
        ...
        public DoctorServiceWithTransaction(IRepository<int, Doctor> doctorRepository,
        ...
        {
            Console.WriteLine("Mapped user:");

            try
            {

                var user = _mapper.Map<DoctorAddRequestDto, User>(doctor);
                Console.WriteLine($"Mapped user: {user.Username}");
                ...
                newDoctor.Email = user.Username;

                newDoctor.User = user; // Set the reference
