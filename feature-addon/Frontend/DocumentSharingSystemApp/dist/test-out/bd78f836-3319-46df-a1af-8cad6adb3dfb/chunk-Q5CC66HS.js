import {
  MatIconModule,
  init_icon
} from "./chunk-S4HMC2TY.js";
import {
  UserService,
  init_user_service
} from "./chunk-W4OQVDNE.js";
import {
  ActivatedRoute,
  Router,
  init_router
} from "./chunk-R37JENKY.js";
import {
  CurrentUserState,
  init_current_user_state
} from "./chunk-Y4YPLOYO.js";
import {
  Store,
  init_ngxs_store
} from "./chunk-4KPETWYZ.js";
import {
  CdkScrollableModule,
  DOWN_ARROW,
  Directionality,
...
var init_navbar = __esm({
  "angular:jit:template:src/app/navbar/navbar.html"() {
    navbar_default = `<mat-toolbar class="navbar">
...
var init_navbar3 = __esm({
  "src/app/navbar/navbar.ts"() {
    ...
    Navbar = class Navbar2 {
      ...
      currentUrl = signal("");
      currentUser = null;
      constructor(route, router, userService, store) {
        this.route = route;
        this.router = router;
...
//# sourceMappingURL=chunk-Q5CC66HS.js.map
