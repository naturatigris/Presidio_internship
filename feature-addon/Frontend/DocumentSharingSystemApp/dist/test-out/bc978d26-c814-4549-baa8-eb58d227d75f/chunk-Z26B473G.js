...
var init_requestdetail = __esm({
  ...
  <div class="request-detail-modal">
    ...
    <ng-container *ngIf="request; else loading">
      <p><strong>Requested By:</strong> {{ currentUser?.name }}</p>
      ...
      <p *ngIf="request.reviewedByUser"><strong>Reviewed By:</strong> {{ request.reviewedByUser.name }}</p>
    </ng-container>
...
//# sourceMappingURL=chunk-Z26B473G.js.map
