...
import {
  MatPaginatorModule,
  init_paginator
} from "./chunk-WTFPHOF6.js";
import {
  MatTabsModule,
  init_tabs
} from "./chunk-IVE3Q6XP.js";
import {
  MatCardModule,
  init_card
...
// angular:jit:template:src/app/documents/documents.html
var documents_default;
var init_documents = __esm({
  "angular:jit:template:src/app/documents/documents.html"() {
    documents_default = `<app-navbar></app-navbar>
<div class="main">
            ...
            @for (doc of documents; track $index) {
                <mat-card class="card"  [style]="doc.isDeleted ? 'background-color:#f17676': ''">
                    ...
                    <mat-card-actions>
                        ...
                        @if (currentUser?.role == "Admin"  && !doc.isDeleted && doc.visibility=="Archived"){
...
// angular:jit:style:src/app/documents/documents.css
var documents_default2;
var init_documents2 = __esm({
  "angular:jit:style:src/app/documents/documents.css"() {
    documents_default2 = "/* src/app/documents/documents.css */\n.main {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n.header {\n  width: 95%;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.spacer {\n  flex: 1 1 auto;\n}\n.content {\n  border: 1px solid #416cd8;\n  border-radius: 12px;\n  margin: 20px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\nmat-paginator {\n  border-radius: 0px 0px 12px 12px;\n  width: 100%;\n}\n.documents {\n  padding: 20px;\n  width: max(90%, max-content);\n  display: grid;\n  grid-template-columns: 1fr 1fr 1fr;\n  align-items: center;\n  row-gap: 20px;\n  gap: 20px;\n}\nmat-expansion-panel {\n  width: 100%;\n  border-radius: 12px;\n}\nmat-expansion-panel-header {\n  height: 80px;\n}\n.controls {\n  width: 95%;\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: space-evenly;\n  align-items: center;\n  margin-bottom: 40px;\n  gap: 30px;\n}\n.search-input {\n  width: 500px;\n  align-self: flex-start;\n}\nmat-button-toggle-group {\n  height: 100%;\n}\nmat-button-toggle {\n  width: 90px;\n}\n.mat-form-field {\n  height: 60px;\n}\nbutton {\n  margin: 10px;\n  justify-self: center;\n}\n.card {\n  width: 450px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  padding: 20px;\n  justify-self: center;\n  background-color: #fbf8fd;\n  height: 500px;\n}\n.error-loading {\n  padding: 40px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 20px;\n}\nmat-card-header {\n  text-align: center;\n}\nmat-card-title {\n  font-size: x-large;\n  padding: 10px;\n}\nmat-card-subtitle {\n  font-size: small;\n}\nmat-card-actions {\n  display: flex;\n  flex-wrap: wrap;\n}\n@media (max-width: 768px) {\n  .controls {\n    row-gap: 10px;\n  }\n  .content {\n    margin: 20px 5px;\n  }\n  .documents {\n    padding: 20px 10px;\n    width: 90%;\n    grid-template-columns: 1fr;\n    row-gap: 20px;\n    border-radius: 16px;\n  }\n  .card {\n    width: 340px;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    padding: 5px;\n    justify-self: center;\n    flex-grow: 1;\n    flex-shrink: 0;\n    height: fit-content;\n  }\n  .search-input {\n    width: 350px;\n  }\n  .createdbyuser-input {\n    width: 300px;\n  }\n  .datepicker {\n    width: 300px;\n  }\n  mat-expansion-panel-header {\n    height: 120px;\n  }\n}\n@media (min-width:1001px) and (max-width:1500px) {\n  .documents {\n    grid-template-columns: 1fr 1fr;\n  }\n  .card {\n    flex-shrink: 1;\n  }\n  .controls {\n    row-gap: 20px;\n  }\n}\n@media (min-width:769px) and (max-width:1000px) {\n  .documents {\n    grid-template-columns: 1fr 1fr;\n  }\n  .card {\n    width: 340px;\n    flex-shrink: 1;\n  }\n  .controls {\n    row-gap: 20px;\n  }\n}\n/*# sourceMappingURL=documents.css.map */\n";
  }
});
...
`, styles: ["div.mat-mdc-autocomplete-panel{width:100%;max-height:256px;visibility:hidden;transform-origin:center top;overflow:auto;padding:8px 0;box-sizing:border-box;position:relative;border-radius:var(--mat-autocomplete-container-shape, var(--mat-sys-corner-extra-small));box-shadow:var(--mat-autocomplete-container-elevation-shadow, 0px 3px 1px -2px rgba(0, 0, 0, 0.2), 0px 2px 2px 0px rgba(0, 0, 0, 0.14), 0px 1px 5px 0px rgba(0, 0, 0, 0.12));background-color:var(--mat-autocomplete-background-color, var(--mat-sys-surface-container))}@media(forced-colors: active){div.mat-mdc-autocomplete-panel{outline:solid 1px}}.cdk-overlay-pane:not(.mat-mdc-autocomplete-panel-above) div.mat-mdc-autocomplete-panel{border-top-left-radius:0;border-top-right-radius:0}.mat-mdc-autocomplete-panel-above div.mat-mdc-autocomplete-panel{border-bottom-left-radius:0;border-bottom-right-radius:0;transform-origin:center bottom}div.mat-mdc-autocomplete-panel.mat-mdc-autocomplete-visible{visibility:visible}div.mat-mdc-autocomplete-panel.mat-mdc-autocomplete-hidden{visibility:hidden;pointer-events:none}@keyframes _mat-autocomplete-enter{from{opacity:0;transform:scaleY(0.8)}to{opacity:1;transform:none}}.mat-autocomplete-panel-animations-enabled{animation:_mat-autocomplete-enter 120ms cubic-bezier(0, 0, 0.2, 1)}mat-autocomplete{display:none}\n"], changeDetection: ChangeDetectionStrategy.OnPush, encapsulation: ViewEncapsulation.None });
    ...
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.0.0", ngImport: core_exports, type: MatAutocomplete, decorators: [{
      type: Component,
...
`, styles: ["div.mat-mdc-autocomplete-panel{width:100%;max-height:256px;visibility:hidden;transform-origin:center top;overflow:auto;padding:8px 0;box-sizing:border-box;position:relative;border-radius:var(--mat-autocomplete-container-shape, var(--mat-sys-corner-extra-small));box-shadow:var(--mat-autocomplete-container-elevation-shadow, 0px 3px 1px -2px rgba(0, 0, 0, 0.2), 0px 2px 2px 0px rgba(0, 0, 0, 0.14), 0px 1px 5px 0px rgba(0, 0, 0, 0.12));background-color:var(--mat-autocomplete-background-color, var(--mat-sys-surface-container))}@media(forced-colors: active){div.mat-mdc-autocomplete-panel{outline:solid 1px}}.cdk-overlay-pane:not(.mat-mdc-autocomplete-panel-above) div.mat-mdc-autocomplete-panel{border-top-left-radius:0;border-top-right-radius:0}.mat-mdc-autocomplete-panel-above div.mat-mdc-autocomplete-panel{border-bottom-left-radius:0;border-bottom-right-radius:0;transform-origin:center bottom}div.mat-mdc-autocomplete-panel.mat-mdc-autocomplete-visible{visibility:visible}div.mat-mdc-autocomplete-panel.mat-mdc-autocomplete-hidden{visibility:hidden;pointer-events:none}@keyframes _mat-autocomplete-enter{from{opacity:0;transform:scaleY(0.8)}to{opacity:1;transform:none}}.mat-autocomplete-panel-animations-enabled{animation:_mat-autocomplete-enter 120ms cubic-bezier(0, 0, 0.2, 1)}mat-autocomplete{display:none}\n"] }]
    ...
    MatAutocompleteOrigin = class _MatAutocompleteOrigin {
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.0.0", ngImport: core_exports, type: _MatAutocompleteOrigin, deps: [], target: FactoryTarget.Directive });
      static \u0275dir = \u0275\u0275ngDeclareDirective({ minVersion: "14.0.0", version: "20.0.0", type: _MatAutocompleteOrigin, isStandalone: true, selector: "[matAutocompleteOrigin]", exportAs: ["matAutocompleteOrigin"], ngImport: core_exports });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.0.0", ngImport: core_exports, type: MatAutocompleteOrigin, decorators: [{
      type: Directive,
      args: [{
    ...
    MatAutocompleteModule = class _MatAutocompleteModule {
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.0.0", ngImport: core_exports, type: _MatAutocompleteModule, deps: [], target: FactoryTarget.NgModule });
      static \u0275mod = \u0275\u0275ngDeclareNgModule({ minVersion: "14.0.0", version: "20.0.0", ngImport: core_exports, type: _MatAutocompleteModule, imports: [
        OverlayModule,
        MatOptionModule,
        MatCommonModule,
        MatAutocomplete,
      ...
      static \u0275inj = \u0275\u0275ngDeclareInjector({ minVersion: "12.0.0", version: "20.0.0", ngImport: core_exports, type: _MatAutocompleteModule, providers: [MAT_AUTOCOMPLETE_SCROLL_STRATEGY_FACTORY_PROVIDER], imports: [
        OverlayModule,
        MatOptionModule,
        MatCommonModule,
        CdkScrollableModule,
    ...
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.0.0", ngImport: core_exports, type: MatAutocompleteModule, decorators: [{
      type: NgModule,
      args: [{
        imports: [
          OverlayModule,
...
var init_documents3 = __esm({
  "src/app/documents/documents.ts"() {
    ...
    Documents = class Documents2 {
      ...
      documents = [];
      currentUser = null;
      documentSearch = new DocumentSearchModel();
      snackbar = new MatSnackBar();
      showStatusOverlay = false;
      selectedId = "";
      documentFilterSubject = new BehaviorSubject(this.documentSearch);
      sortByList = [
        { value: "id", view: "Id" },
      ...
      createdByUsersList = [];
      teamByList = [];
      constructor(userService, documentService, teamService, documentrestoreService, dialog, store) {
      ...
      loadList() {
        ...
        this.userService.getAllUsers().subscribe((data) => {
          this.createdByUsersList = data.$values.map((u) => ({
            value: u.email,
            view: `${u.name} (${u.email})`
          }));
        });
      ...
      setTab(value) {
        ...
        if (value == "My Docs") {
          this.documentSearch.searchByCreatedUserEmail = this.currentUser?.email;
      ...
      handleUpload() {
        this.dialog.open(UploadModal, { data: {
          ...
          action: "Add",
          onAccept: (fileData, uploadFile) => {
            this.documentService.uploadDocument(this.currentUser, fileData, uploadFile).pipe(switchMap(() => this.documentService.getByFilter(this.currentUser, this.documentSearch).pipe(catchError((err) => {
              ...
              next: (data) => {
                console.log(data);
                this.documents = [];
                data.data.$values.forEach((doc) => {
                  this.documents.push(DocumentModel.fromData(doc));
                });
                this.snackbar.open("File uploaded successfully!", void 0, { duration: 3e3 });
              }
            });
          }
        } });
      ...
      archive(doc) {
        var document2 = new DocumentDetailsModel(doc.description, doc.teamId, "Archived");
        this.documentService.updateDocumentDetails(this.currentUser, doc.id, document2).pipe(switchMap(() => this.documentService.getByFilter(this.currentUser, this.documentSearch).pipe(catchError((err) => {
          console.error("API error:", err);
          if (err.error.errors) {
            this.errorMessage = err.error.errors.message;
            this.snackbar.open(err.error.errors.message, void 0, { duration: 3e3 });
          ...
          next: (data) => {
            console.log(data);
            this.documents = [];
            data.data.$values.forEach((doc2) => {
              this.documents.push(DocumentModel.fromData(doc2));
            });
            this.snackbar.open("File archived successfully!", void 0, { duration: 3e3 });
          }
        });
      }
      unarchive(doc) {
        var document2 = new DocumentDetailsModel(doc.description, doc.teamId, "Private");
        this.documentService.updateDocumentDetails(this.currentUser, doc.id, document2).pipe(switchMap(() => this.documentService.getByFilter(this.currentUser, this.documentSearch).pipe(catchError((err) => {
          console.error("API error:", err);
          if (err.error.errors) {
            this.errorMessage = err.error.errors.message;
        ...
        this.dialog.open(DocumentRequestModal, {
          data: {
            ...
            onAccept: (Reason) => {
              ...
              this.documentrestoreService.requestRestore(this.currentUser, req).pipe(switchMap(() => this.documentService.updateDocumentDetails(this.currentUser, doc.id, update)), switchMap(() => this.documentService.getByFilter(this.currentUser, this.documentSearch).pipe(catchError((err) => {
                console.error("API error:", err);
                ...
                next: (data) => {
                  ...
                  this.snackbar.open("access Requested successfully!", void 0, { duration: 3e3 });
                }
              });
            }
          }
      ...
      handleEdit(doc) {
        this.dialog.open(UploadModal, { data: {
          ...
          action: "Edit",
          onAccept: (fileData) => {
            this.documentService.updateDocumentDetails(this.currentUser, doc.id, fileData).pipe(switchMap(() => this.documentService.getByFilter(this.currentUser, this.documentSearch).pipe(catchError((err) => {
              console.error("API error:", err);
              if (err.error.errors) {
                this.errorMessage = err.error.errors.message;
                this.snackbar.open(err.error.errors.message, void 0, { duration: 3e3 });
              ...
              next: (data) => {
                ...
                this.snackbar.open("File edited successfully!", void 0, { duration: 3e3 });
              }
            });
          }
        } });
      ...
      onDelete(id) {
        this.documentService.deleteDocument(this.currentUser, id).pipe(switchMap(() => this.documentService.getByFilter(this.currentUser, this.documentSearch).pipe(catchError((err) => {
          console.error("API error:", err);
          if (err.error.errors) {
            this.errorMessage = err.error.errors.message;
            this.snackbar.open(err.error.errors.message, void 0, { duration: 3e3 });
      ...
      onDownload(doc) {
        this.documentService.downloadDocument(this.currentUser, doc.id).subscribe((blob) => {
      ...
      openDeleteDialog(message, id) {
        this.dialog.open(Dialog, {
          data: {
            ...
            onAccept: () => {
              this.onDelete(id);
              this.snackbar.open(`Document ${message} deleted successfully!`, void 0, { duration: 3e3 });
            }
          }
        });
      }
      ...
      ngOnInit() {
        ...
        this.documentFilterSubject.pipe(debounceTime(500), tap(() => {
          console.log("API Called");
        }), switchMap((query) => this.documentService.getByFilter(this.currentUser, query).pipe(catchError((err) => {
          console.error("API error:", err);
          if (err.error.errors) {
            this.errorMessage = err.error.errors.message;
    ...
    Documents = __decorate([
      Component({
        ...
        template: documents_default,
        providers: [
          provideNativeDateAdapter(),
          { provide: MAT_FORM_FIELD_DEFAULT_OPTIONS, useValue: { appearance: "outline" } }
          // {provide: MatPaginatorIntl, useValue :{itemsPerPageLabel : "Documents per page"}}
        ],
        styles: [documents_default2]
      })
    ], Documents);
  }
});

// src/app/documents/documents.spec.ts
var require_documents_spec = __commonJS({
  "src/app/documents/documents.spec.ts"(exports) {
    init_tslib_es6();
    init_testing();
    init_documents3();
    init_core();
    ...
    describe("Documents", () => {
      ...
      it("should get documents data", () => __async(null, null, function* () {
      ...
      it("should delete document", () => __async(null, null, function* () {
      ...
      it("should download document", () => __async(null, null, function* () {
...
export default require_documents_spec();
//# sourceMappingURL=spec-app-documents-documents.spec.js.map
