...
namespace BlogPlatform.Tests.Services
{
    public class UserServiceConcreteRepoTests
    {
        ...
        public void Setup()
        {
            ...
            _userService = new UserService(_context, _userRepository, _postRepository, _auditLogRepository);
        }
        ...
        [Test]
        public async Task UpdateUser_ShouldUpdateAndLogChanges()
        {
            ...
            await _userService.AddUser(originalUser, "admin@example.com");
            ...
            var result = await _userService.UpdateUser("test@example.com", updatedUser, "admin@example.com");
